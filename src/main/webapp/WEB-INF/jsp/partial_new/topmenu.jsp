    ...
    <div class="ecommerce-topbar">
      <nav class="navbar navbar-expand-lg navbar-light px-0">
        <div class="row gx-0 gy-2 w-100 flex-between-center">
          <div class="col-auto"><a class="text-decoration-none" href="${pageContext.request.contextPath}/home">
            <div class="d-flex align-items-center"><img src="${pageContext.request.contextPath}/assets/img/icons/logo_c.png" alt="phoenix" width="27" />
              <p class="logo-text ms-2">App Market</p>
            </div>
          </a></div>
          <div class="col-auto order-md-1">
            <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
              ...
              <li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary" href="${pageContext.request.contextPath}/cart" role="button"><span class="text-700" data-feather="shopping-cart" style="height:20px;width:20px;"></span><span class="icon-indicator-number">3</span></a></li>
                      ...
                      <div class="overflow-auto" style="height: 27rem;">
                        <div class="border-300">
                          <div class="p-3 border-300 notification-card position-relative read border-bottom">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                              <div class="d-flex">
                                <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="${pageContext.request.contextPath}/assets/img/team/30.png" alt="" />
                                </div>
                          ...
                          <div class="p-3 border-300 notification-card position-relative unread border-bottom">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                              <div class="d-flex">
                                <div class="avatar avatar-m status-online me-3"><img class="rounded-circle avatar-placeholder" src="${pageContext.request.contextPath}/assets/img/team/avatar.png" alt="" />
                                </div>
                                <div class="me-3 flex-1">
                                  <h4 class="fs--1 text-black">Jessie Samson</h4>
                        ...
                        <div class="border-300">
                          <div class="p-3 border-300 notification-card position-relative unread border-bottom">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                              <div class="d-flex">
                                <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="${pageContext.request.contextPath}/assets/img/team/57.png" alt="" />
                                </div>
                                <div class="me-3 flex-1">
                          ...
                          <div class="p-3 border-300 notification-card position-relative unread border-bottom">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                              <div class="d-flex">
                                <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="${pageContext.request.contextPath}/assets/img/team/59.png" alt="" />
                                </div>
                                <div class="me-3 flex-1">
                          ...
                          <div class="p-3 border-300 notification-card position-relative read ">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                              <div class="d-flex">
                                <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="${pageContext.request.contextPath}/assets/img/team/58.png" alt="" />
                                </div>
                                <div class="me-3 flex-1">
                  ...
                  <div class="card position-relative border-0">
                    <div class="card-body p-0">
                      <div class="text-center pt-4 pb-3">
                        <div class="avatar avatar-xl ">
                          <img class="rounded-circle " src="${pageContext.request.contextPath}/assets/img/team/57.png" alt="" />
                    ...
                    <div class="overflow-auto scrollbar" style="height: 10rem;">
                      <ul class="nav d-flex flex-column mb-2 pb-1">
                        <li class="nav-item"><a class="nav-link px-3" href="${pageContext.request.contextPath}/profile"> <span class="me-2 text-900" data-feather="user"></span>Profile</a></li>
                        <!--
                                                                            <li class="nav-item"><a class="nav-link px-3" href="apps/e-commerce/landing/"> <span class="me-2 text-900" data-feather="lock"></span>Posts &amp; Activity</a></li>
                        -->
                    ...
                    <div class="card-footer p-0 border-top">
                      ...
                      <hr />
                      <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="${pageContext.request.contextPath}/logout"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
