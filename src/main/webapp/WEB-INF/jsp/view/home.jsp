                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="dropdown mr-2">
                                            <button class=" text-left  btn full-width btn-outline-secondary dropdown-toggle"
                                                    type="button"
                                        ...
                                        <div class="col-lg-8 col-md-7 col-6 mt-4">
                                            <div class="d-flex flex-column mt-4">
                                                <div class="d-flex justify-content-between gap-3 gap-sm-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="${pageContext.request.contextPath}/assets/v2/dist/img/indicator.svg"
                                                             alt="png"/>
                                                ...
                                                <div class="d-flex align-items-center gap-2 mt-4">
                                                    <img src="${pageContext.request.contextPath}/assets/v2/dist/img/Subtract.svg"
                                                         alt="png"/>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-lg-4 text-center">
                                                ...
                                                <input type="text" class="knob" data-thickness="0.2" data-anglearc="250"
                                                       data-angleoffset="-125" value="30" data-width="120"
