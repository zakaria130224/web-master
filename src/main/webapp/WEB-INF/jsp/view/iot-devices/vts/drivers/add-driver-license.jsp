              ...
              <div class="card-body">
                ...
                <form class="form-horizontal b2b-custom-form">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="license_number" placeholder="Write here">
                  </div>
                  <div class="form-group">
                    <label>Issue Date</label>
                    <input type="text" class="form-control" id="Issue date" placeholder="Select date">
                  </div>
                  <div class="form-group">
                    <label>Expiry Date</label>
                    <input type="text" class="form-control" id="exp_date" placeholder="Write here">
                  </div>
                  <div class="form-group">
