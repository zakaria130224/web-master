              ...
              <div class="card-body">
                ...
                <form class="form-horizontal b2b-custom-form" id="driver_basic_info">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="name" placeholder="Write here" value="${driver_info.name}">
                  </div>
                  <div class="form-group">
                    <label>Date of Birth</label>
                    <input type="hidden" id="dob_hidden" value="${driver_info.dob}">
                    <input type="date" class="form-control" id="dob" placeholder="Select Date">
                  </div>
                  <div class="form-group">
                    <label>Phone Number <span class="text-red">*</span></label>
                    <input type="text" class="form-control" required id="mobile_number" placeholder="Ex:01777-111111" value="${driver_info.mobile_number}">
                  </div>
                  <div class="form-group">
                    <label>Email <span class="text-red">*</span></label>
                    <input type="email" class="form-control" id="email" required placeholder="Enter email address" value="${driver_info.email}">
                  </div>
                  <div class="form-group">
                    <label>Designation</label>
                    <input type="text" class="form-control" id="designation" placeholder="Write here" value="${driver_info.designation}">
              ...
              <div class="card-body">
                ...
                <form class="form-horizontal b2b-custom-form" id="driver_license_info">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="license_no" placeholder="Write here" value="${driver_info.license_no}">
                  </div>
                  <div class="form-group">
                    <label>Issue Date  <span class="text-red">*</span></label>
                    <input type="date" class="form-control" id="license_issue_date" placeholder="Select date" value="${driver_info.license_issue_date}">
                  </div>
                  <div class="form-group">
                    <label>Expiry Date  <span class="text-red">*</span></label>
                    <input type="date" class="form-control" id="license_expired_date" placeholder="Select date" value="${driver_info.license_expired_date}">
                  </div>
                  <div class="form-group">
            ...
            <div class="card b2b-custom-card" id="driver-additional-form-card">
              <div class="card-body">
                ...
                <form class="form-horizontal b2b-custom-form" id="driver-additional-info">
                    ...
                    <select class="form-control" id="reports_to" required>
                      <c:forEach var="item" items="${userList}">
                        <option value="<c:out value='${item.id}'/>"
                                <c:if test="${param.selectValue == item.id})"> selected </c:if>  >
                                <c:out value="${item}" />
                        </option>
                      </c:forEach>
                    </select>
                  ...
                  <div class="form-group">
                    <label>Notes</label>
                    <textarea type="text" class="form-control" id="additional_note" placeholder="Write here" value="${driver_info.additional_note}"></textarea>
                  </div>
                </form>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    let dobVal = $("#dob_hidden").val();
    formatDateVal(dobVal, "dob");
  });

  function formatDateVal(val, id){
      date = new Date(val);
      let dateFormatted = date.getFullYear()+"-"+("0" + (date.getMonth() + 1)).slice(-2)+"-"+("0" + date.getDate()).slice(-2);
