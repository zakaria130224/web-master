                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <div class="card b2b-custom-card p-2">
                            ...
                            <a class="" href="${pageContext.request.contextPath}/vts/add-vehicle-info">
                                <div class="card-body card-body-form-tab">
                                    <div class="tab-custom-number active float-left">2</div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal b2b-custom-form">
                                    <div class="form-group">
                                        <label>Manager <span class="text-red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label>Fuel Conversion (Fuel)</label>
                                        <input type="text" class="form-control" id="fuel_conversion" placeholder="Fuel">
                                    </div>
                                    <div class="form-group">
                                        <label>Estimated Mileage (Km/L) *</label>
                                        <input type="text" class="form-control" id="estimated_millage" placeholder="Fuel in (Km/L)">
                                    </div>
