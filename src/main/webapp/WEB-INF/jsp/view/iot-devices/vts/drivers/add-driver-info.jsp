                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal b2b-custom-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first_name" placeholder="Write here">
                                    </div>
                                    <div class="form-group">
                                        <label>Last Name *</label>
                                        <input type="text" class="form-control" id="last_name" placeholder="Write here">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="pnone_no" placeholder="Enter phone number">
                                    </div>
                                    <div class="form-group">
