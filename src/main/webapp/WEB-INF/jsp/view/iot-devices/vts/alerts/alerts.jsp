                            ...
                            <div class="card-body">
                                <div class="card-head-custom">
                                    <div class="float-left">
                                        <h3 class="b2b-font-20-500 black-10 float-left">All Alarms</h3>
                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" id="dataTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <i class="fa fa-minus-circle text-blue"></i> Standard Demo has Left Airport
                                                            </td>
                                                            <td>Standard Demo</td>
                                                            <td>Standard Driver</td>
                                                            <td>3rd May 2023</td>
                                                            <td><div class="severity-dot bg-red float-left"></div> <span class="text-red">Emergency</span></td>
                                                            <td>1h 30m</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="fa fa-minus-circle text-blue"></i> Standard Demo has Left Airport</td>
                                                            <td>Standard Demo</td>
                                                            <td>Standard Driver</td>
                                                            <td>3rd May 2023</td>
                                                            <td><div class="severity-dot bg-orange float-left"></div> <span class="text-orange">Major</span></td>
                                                            <td>1h 30m</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="fa fa-minus-circle text-blue"></i> Standard Demo has Left Airport</td>
                                                            ...
                                                            <td>Standard Driver</td>
                                                            <td>3rd May 2023</td>
                                                            <td><div class="severity-dot bg-black float-left"></div> <span class="text-black">Minor</span></td>
                                                            <td>1h 30m</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
