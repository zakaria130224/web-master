                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <div class="card b2b-custom-card p-2">
                            ...
                            <a class="" href="${pageContext.request.contextPath}/vts/add-vehicle-purchase-info">
                                <div class="card-body card-body-form-tab">
                                    <div class="tab-custom-number active float-left">3</div>
                            ...
                            <div class="card-body">
                                <div class="card-head-custom">
                                    <div class="float-left">
                                        <h3 class="b2b-font-20-500 black-10 float-left">Purchase Info</h3>
                                    </div>
                                </div>
                                ...
                                <form class="form-horizontal b2b-custom-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="chassis_no" placeholder="Write Number">
                                    </div>
                                    <div class="form-group">
                                        <label>Engine Number</label>
                                        <input type="text" class="form-control" id="engine_no" placeholder="Write Number">
                                    </div>
                                    <div class="form-group">
                                        <label>Installation Date</label>
                                        <input type="text" class="form-control" id="install_date" placeholder="Select Date">
                                    </div>
                                    <div class="form-group">
                                        <label>Warranty Expiration Date</label>
                                        <input type="text" class="form-control" id="warranty_exp_date" placeholder="Select Date">
                                    </div>
                                    <div class="form-group">
                                        <label>Color</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="body_type" placeholder="Body Type">
                                    </div>
