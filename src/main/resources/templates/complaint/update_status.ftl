...
<![endif]-->
    <div class="body-wrapper" style="
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="background: #000F3C; background-color: #000F3C; width: 100%">
        <tbody>
          <tr>
            <td style="
                  font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="
                                            ...
                                            width: 160px;
                                          " width="160">
                                        <a href="https://iot.grameenphone.com/" target="_blank" style="
                                              font-family: Open Sans, Helvetica,
                                                Tahoma, Arial, sans-serif;
                                              padding: 0 10px;
                                            ">
                                          <img alt="VamShop" height="auto" src="https://tteche.grameenphone.com/resources/email/leads/logo.png" style="
                                                border: 0;
                                                display: block;
                                                outline: none;
                                                text-decoration: none;
...
<td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
<![endif]-->
              <div class="notice-wrap margin-bottom" style="
                    font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;
                    margin: 0px auto;
                    max-width: 560px;
                    margin-bottom: 15px;
                                    ...
                                    <tr>
                                      <td align="left" style="
                                        ...
                                        <div style="
                                              ...
                                              color: #4f4f4f;
                                            ">
                                          ${comStatusName} Notification!
                                        </div>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td align="left" class="link-wrap" style="
                                            font-family: Open Sans, Helvetica,
                                              Tahoma, Arial, sans-serif;
                                            font-size: 0px;
                                            padding: 0;
                                        ...
                                        <div style="
                                            ...
                                            ">
                                          <br />
                                          Dear Concern <br />We appreciate your engagement with our esteemed customer.
                                          Kindly apply your expertise to address the matter promptly and with urgency.
                                          <br />
                                          <br />
                                    ...
                                    <tr>
                                      <td align=" left" class="link-wrap" style="
                                        ...
                                        <div style="
                                          ...
                                          <div class="server-box-one" style="
                            ...
                            ">
                                  ...
                                  ">
                                    ...
                                    ">
                                      ...
                                      font-size: 14px;
                                    ">
                                                              <strong>Complaint Created:</strong>${createdAt}<br />
                                                            </div>
                                                            <br />
                                      ...
                                      font-size: 14px;
                                    ">
                                                              Kindly access our platform at
                                                              <a target="_blank"
                                                                href="https://iot.grameenphone.com">iot.grameenphone.com</a>
                                                              to complete the product journey. We
                              ...
                              <tr>
                                <td align="center" style="
                                  ...
                                  <div style="
                                      ...
                                      ">
                                    <div>
                                      <a href="https://www.grameenphone.com/" target="_blank" style="
                                            color: #333333;
                                            line-height: 20px;
                                            text-decoration: underline;
                                          ">Website</a>
                                      |
                                      <a href="https://www.instagram.com/grameenphone" style="
                                            color: #333333;
                                            line-height: 20px;
                                            text-decoration: underline;
                                          ">Instagram</a>
                                      |
                                      <a href="https://www.facebook.com/Grameenphone/" target="_blank" style="
                                            color: #333333;
                                            line-height: 20px;
                                            text-decoration: underline;
                                          ">Facebook</a>
                                      |
                                      <a href="https://www.youtube.com/user/grameenphone" style="
                                            color: #333333;
                                            line-height: 20px;
                                            text-decoration: underline;
                                          ">YouTube</a>
                                      |
                                      <a href="https://www.linkedin.com/company/grameenphone-ltd/" target="_blank"
                                        style="
                                            color: #333333;
                                            line-height: 20px;
                                            text-decoration: underline;
